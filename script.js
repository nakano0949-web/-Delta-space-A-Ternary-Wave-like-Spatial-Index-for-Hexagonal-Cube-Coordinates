        ...
        function draw() {
            ...
            for (let q = -30; q <= 30; q++) {
                for (let r = Math.max(-30, -q-30); r <= Math.min(30, -q+30); r++) {
                    ...
                    ctx.closePath(); ctx.strokeStyle = "rgba(0, 200, 255, 0.25)"; ctx.stroke();
                }
            }
        }
